  ...
  return (
    <div className="recovery-screen">
        ...
        <div style={{ padding: "56px 24px 20px", display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <p style={{ fontSize: 12, fontWeight: 700, color: "#191A2E", margin: 0 }}>Forgot password?</p>
            <p style={{ fontSize: 12, color: "#62657A", margin: "2px 0 0" }}>We'll send a reset link to your email</p>
          </div>
        </div>
        ...
        <div style={{ flex: 1, padding: "8px 24px 40px", display: "flex", flexDirection: "column" }}>
          {sent ? (
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
              ...
              <p style={{ fontSize: 12, fontWeight: 700, color: "#191A2E", marginBottom: 10 }}>Check your inbox</p>
              <p style={{ fontSize: 13, color: "#62657A", lineHeight: 1.6, marginBottom: 32 }}>
                If an account exists for <strong style={{ color: "#191A2E" }}>{email}</strong>, a reset link has been sent. It expires in 15 minutes.
              </p>
              <button onClick={onBack} style={{ fontSize: 13, fontWeight: 600, color: "#7679FF", background: "none", border: "none", cursor: "pointer" }}>
                ← Back to sign in
              </button>
            </div>
          ) : (
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#191A2E", marginBottom: 8 }}>Email address</label>
                <input
